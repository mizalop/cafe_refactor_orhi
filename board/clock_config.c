...
/*******************************************************************************
 * Variables for ORHY_BootClockRUN configuration
 ******************************************************************************/
const scg_sys_clk_config_t g_sysClkConfig_ORHY_BootClockRUN =
    {
...
const scg_sosc_config_t g_scgSysOscConfig_ORHY_BootClockRUN =
    {
...
const scg_sirc_config_t g_scgSircConfig_ORHY_BootClockRUN =
    {
...
const scg_firc_config_t g_scgFircConfig_ORHY_BootClockRUN =
    {
...
const scg_lpfll_config_t g_scgLpFllConfig_ORHY_BootClockRUN =
    {
...
/*******************************************************************************
 * Code for ORHY_BootClockRUN configuration
 ******************************************************************************/
void ORHY_BootClockRUN(void)
{
    ...
    /* Init FIRC. */
    CLOCK_CONFIG_FircSafeConfig(&g_scgFircConfig_ORHY_BootClockRUN);
    /* Init SIRC. */
    CLOCK_InitSirc(&g_scgSircConfig_ORHY_BootClockRUN);
    /* Init LPFLL. */
    CLOCK_InitLpFll(&g_scgLpFllConfig_ORHY_BootClockRUN);
    /* Set SCG to LPFLL mode. */
    CLOCK_SetRunModeSysClkConfig(&g_sysClkConfig_ORHY_BootClockRUN);
    /* Wait for clock source switch finished. */
    do
    {
         CLOCK_GetCurSysClkConfig(&curConfig);
    } while (curConfig.src != g_sysClkConfig_ORHY_BootClockRUN.src);
    /* Set SystemCoreClock variable. */
    SystemCoreClock = ORHY_BOOTCLOCKRUN_CORE_CLOCK;
